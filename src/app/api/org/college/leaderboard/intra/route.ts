      ...
      students.map(async (student) => {
        if (!student.userId) {
          return {
            ...
            tournamentsPlayed: student.tournamentsPlayed || 0,
            wins: student.matchesWon || 0,
            matches: (student.matchesWon || 0) + (student.matchesLost || 0),
            winRate:
              (student.matchesWon || 0) + (student.matchesLost || 0) > 0
                ? Math.round(
                    ((student.matchesWon || 0) /
                      ((student.matchesWon || 0) + (student.matchesLost || 0))) *
                      100,
                  )
                : 0,
            profileImageUrl: student.user?.photoUrl,
          };
        }
