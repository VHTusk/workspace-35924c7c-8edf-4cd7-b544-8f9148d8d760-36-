...
export default function SportError({
  ...
  useEffect(() => {
    console.error('Sport-level error:', error);
  }, [error]);
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-background">
      <Card className="w-full max-w-md text-center">
        <CardHeader>
          ...
          <CardTitle className="text-2xl">Failed to Load Sport</CardTitle>
          <CardDescription>
            There was an error loading this sport&apos;s data. Please try again.
          </CardDescription>
        </CardHeader>
