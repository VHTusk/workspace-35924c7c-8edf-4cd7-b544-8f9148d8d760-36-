...
export default async function SportHomePage({ params, searchParams }: Props) {
  ...
  const config: SportConfig = isCornhole
    ...
    : {
        ...
        heroImage: "/images/hero/darts/focused-thrower.png",
        demoImage: "/images/hero/darts/bullseye-detail.png",
        mediaImages: [
          "/images/hero/darts/focused-thrower.png",
          "/images/hero/darts/bullseye-detail.png",
          "/images/hero/darts/focused-thrower.png",
        ],
