...
export default async function SportHomePage({ params, searchParams }: Props) {
  ...
  const config: SportConfig = isCornhole
    ? {
        ...
        demoImage: "/images/hero/cornhole/bags-case-set.png",
        mediaImages: [
          "/images/hero/cornhole/tournament-progress.png",
          "/images/hero/cornhole/action-panels.png",
          "/images/hero/cornhole/leaderboard-display.png",
          "/images/hero/cornhole/sportsmanship.png",
        ],
    ...
    : {
        ...
        demoImage: "/images/hero/darts/dartboard-red-surround.png",
        mediaImages: [
          "/images/hero/darts/match-in-progress.png",
          "/images/hero/darts/champion-stage.png",
          "/images/hero/darts/target-alignment.png",
          "/images/hero/darts/trophy-globe.png",
        ],
