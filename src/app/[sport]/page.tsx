...
import { Trophy, Calendar, MapPin, TrendingUp, ChevronRight, Target, Medal, Users, Award, IndianRupee } from "lucide-react";
...
export default async function SportHomePage({ params }: { params: Promise<{ sport: string }> }) {
  ...
  const [tournamentCount, playerCount, cityCount] = await (async () => {
    try {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center">
            ...
            <div className="order-2 lg:order-1 max-w-xl">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-4">
                ...
                <br />
                <span className={cn("bg-gradient-to-r bg-clip-text text-transparent", gradientClass)}>Across India</span>
              </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card className="border-border overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <CardContent className="p-4">
                  <h3 className="font-semibold text-foreground mb-2">City Championship</h3>
              ...
              <Card className="border-border overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <CardContent className="p-4">
                  <h3 className="font-semibold text-foreground mb-2">State Open</h3>
                  <p className="text-sm text-muted-foreground mb-3">Registration Opening Soon</p>
                  <Link href={`/${sport}/tournaments`}>
                    <Button size="sm" variant="outline" className="w-full">View Details</Button>
                  </Link>
                </CardContent>
            ...
            <Card className="border-border text-center hover:shadow-lg transition-shadow bg-card">
              <CardContent className="p-6">
                <div className={cn(
                  ...
                  isCornhole ? "bg-green-100 dark:bg-green-900/30 border-green-200 dark:border-green-800" : "bg-teal-100 dark:bg-teal-900/30 border-teal-200 dark:border-teal-800"
                )}>
